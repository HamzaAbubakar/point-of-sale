            ...
            <div class="col-lg-12">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <p class="mb-0">List of all purchases from suppliers.</p>
                    </div>
                    <div>
                        <a href="{{ route('purchase.allPurchases') }}" class="btn btn-danger add-list d-flex align-items-center">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('purchase.allPurchases') }}" method="get">
                            ...
                            <table class="table mb-0">
                                <thead class="bg-white text-uppercase">
                                    <tr class="ligth ligth-data">
                                        <th>No.</th>
                                        <th>Purchase No</th>
                                        <th><x-sort-link name="supplier.name" label="Supplier" /></th>
                                        <th><x-sort-link name="purchase_date" label="Date" /></th>
                                        <th>Payment</th>
                                ...
                                <tbody class="ligth-body">
                                    @forelse ($purchases as $purchase)
                                        <tr>
                                            <td>{{ (($purchases->currentPage() * 10) - 10) + $loop->iteration }}</td>
                                            ...
                                            <td>
                                                <span class="badge badge-success">{{ ucfirst($purchase->purchase_status) }}</span>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center list-action">
                                                    <a class="btn btn-info mr-2" data-toggle="tooltip" data-placement="top"
                                                        title="Details"
                                                        href="{{ route('purchase.purchaseDetails', $purchase->id) }}">
