                ...
                <div class="list-group-item p-3 border-0 border-bottom">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <input type="number" id="price-{{ $item->rowId }}" class="form-control form-control-sm border-0 bg-light text-center"
                                style="width: 100px;"
                                value="{{ $item->price }}"
                                onchange="updateCart('{{ $item->rowId }}', {{ $item->qty }}, this.value)">
                        </div>
