            ...
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                ...
                <form onsubmit="submitOrder(event)">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div id="transaction_details" style="display: none;" class="mt-3 border-top pt-3">
                            <h6 class="font-weight-bold mb-3">Transaction Details</h6>
                            ...
                            <div class="form-group">
                                <label for="pay_transaction_id">Transaction ID <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="pay_transaction_id" id="pay_transaction_id" placeholder="Enter Transaction ID">
                            </div>
                            <div class="form-group">
                                <label for="pay_date">Transaction Date <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" name="pay_date" id="pay_date" value="{{ date('Y-m-d') }}">
                            </div>
                        </div>
                    </div>
                    <!-- Modal Actions -->
    ...
    <script>
        ...
        function calculateChange() {
            ...
            if (!isNaN(payInput) && payInput >= 0) {
                ...
                if (change < 0) {
                    changeElement.innerText = "Due: " + Math.abs(change).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        ...
        function validateAndShowModal() {
            ...
            const changeElement = document.getElementById('modal_change_amount');
            ...
            const transactionId = document.getElementById('pay_transaction_id');
        ...
        async function submitOrder(event) {
            ...
            // Add Transaction Details if Transfer
            if (paymentTypeElem && paymentTypeElem.value === 'Transfer') {
                const bankName = document.getElementById('bank_name').value;
                const transactionId = document.getElementById('pay_transaction_id').value;
                const payDate = document.getElementById('pay_date').value;

                if (!bankName || !transactionId || !payDate) {
                    alert('Please fill in all transaction details!');
                    return;
                }

                formData.append('bank_name', bankName);
                formData.append('pay_transaction_id', transactionId);
